...
export default function PrivacyPolicy() {
  const accept = () => {
    ...
    // Reemplaza Políticas por Home para fijarlo como la pantalla principal definitiva
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#F5F5F5', justifyContent: 'center', alignItems: 'center', padding: '4%' },
  card: { width: '100%', maxWidth: 500, height: '90%', backgroundColor: '#FFFFFF', borderRadius: 25, overflow: 'hidden', elevation: 6, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.15, shadowRadius: 6 },
  header: { backgroundColor: '#EECFA7', alignItems: 'center', paddingVertical: '5%', paddingHorizontal: '5%' },
  logoContainer: { width: 75, height: 75, borderRadius: 22, overflow: 'hidden', justifyContent: 'center', alignItems: 'center', marginBottom: 8, backgroundColor: '#FFFFFF' },
  logoImage: { width: '100%', height: '100%' },
  title: { fontSize: 20, fontWeight: 'bold', color: '#3B3B3B', textAlign: 'center' },
  subtitle: { marginTop: 4, fontSize: 14, color: '#726B25', fontWeight: '600' },
  content: { flex: 1 },
  scrollContentContainer: { paddingHorizontal: '5%', paddingTop: 16, paddingBottom: 24 },
  paragraph: { fontSize: 14, color: '#444444', lineHeight: 22, marginBottom: 16, textAlign: 'justify' },
  buttonContainer: { padding: '4%', backgroundColor: '#FFFFFF', borderTopWidth: 1, borderTopColor: '#F0F0F0' },
  button: { backgroundColor: '#B8D95B', paddingVertical: 14, borderRadius: 30, alignItems: 'center', width: '100%' },
