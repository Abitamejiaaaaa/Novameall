...
export default function Pago() {
  ...
  const cantidadRecibida = params.cantidadPupusas ? Number(params.cantidadPupusas) : 1;

  const lat = params.lat ? Number(params.lat) : null;
  const lng = params.lng ? Number(params.lng) : null;

  const [productos, setProductos] = useState([
    { id: 1, nombre: 'Pupusas', precioUnitario: 0.50, cantidad: cantidadRecibida, imagen: require('@/assets/images/pupusas.jpg') },
  ]);
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          ...
          {/* AQUÍ ESTÁ EL CAMBIO: Se indica que el mapa debe regresar a esta pantalla específica de pupusas */}
          <TouchableOpacity 
            style={styles.address} 
            onPress={() => router.push({
              pathname: "/mapa",
              params: { returnScreen: "/PagoPupusas" } // Ajusta esta ruta según el nombre exacto de tu archivo
            })}
          >
