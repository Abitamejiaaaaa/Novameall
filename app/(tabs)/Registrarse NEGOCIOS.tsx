...
export default function Registro() {
  ...
  const registrarNegocio = async (): Promise<void> => {

    if (!name.trim() || !ubicacion.trim() || !email.trim() || !password) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.title}>Welcome negocio</Text>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                ...
                placeholderTextColor="#A0A0A0"
                value={ubicacion}
                onChangeText={(text: string) => setUbicacion(text)}
              />
            </View>
