...
export default function Cantidad() {
  ...
  const irAPagar = () => {
    router.push({
      pathname: "/Pago-lemon"as any,
      params: { cantidadLemonades: cantidad },
    });
  };
      ...
      >
        <View style={styles.topSection}>
          ...
          <Pressable onPress={() => router.push("/(tabs)/Restaurante")}>
            <Image
              source={require("@/assets/images/lemon.webp")}
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.description}>
            A refreshing glass of lemonade, bursting with zesty citrus flavor. Freshly squeezed
            lemons blended with cool water and a touch of sweetness create the perfect balance—bright,
            crisp, and irresistibly thirst‑quenching.
          </Text>
