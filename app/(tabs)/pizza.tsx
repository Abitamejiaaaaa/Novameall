      ...
      <View style={styles.content}>
        <View>
          ...
          <Text style={styles.description}>
            Deliciosa pizza preparada con una masa suave y crujiente,
            cubierta con queso derretido, salsa de tomate y deliciosos
            ingredientes frescos. Una opción perfecta para disfrutar
            y compartir.
          </Text>
        </View>
